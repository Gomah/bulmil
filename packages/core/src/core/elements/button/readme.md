...
| ------------- | -------------- | -------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- |
| `color`       | `color`        | Color                            | `"is-black" \| "is-danger" \| "is-dark" \| "is-ghost" \| "is-info" \| "is-light" \| "is-link" \| "is-primary" \| "is-success" \| "is-text" \| "is-warning" \| "is-white"` | `undefined` |
...
| `isFullwidth` | `is-fullwidth` | Display the button in full-width | `boolean`                                                                                                                                                                 | `false`     |
